...
type Conv struct {
	...
	SpNamedSchemas     map[string]ddl.CreateNamedSchema // Maps Spanner Named Schemas to Named Schemas information
	SrcNamedSchemas    map[string]schema.NamedSchema    // Maps source-DB Named Schemas to Named Schemas information
}
...
func MakeConv() *Conv {
	return &Conv{
		...
		SpNamedSchemas:  make(map[string]ddl.CreateNamedSchema),
